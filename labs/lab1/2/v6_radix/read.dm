...
магическме числа
стринг ту инт
изменить строку на основания на поиск по аски
уменьшить вложенность в стринг ту инт
добавить тест основание больше допустиномго и меньше
